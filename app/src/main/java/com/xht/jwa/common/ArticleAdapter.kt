...
import com.xht.jwa.databinding.ItemHomeArticleBinding
import com.xht.jwa.databinding.ItemProjectBinding

class ArticleAdapter(private val context: Context) :
    ListAdapter<ArticleListBean, RecyclerView.ViewHolder>(
        getArticleDiff()
    ) {
    ...
    override fun submitList(list: MutableList<ArticleListBean>?) {
